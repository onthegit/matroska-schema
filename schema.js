module.exports = {
  byEbmlID: {
    ...
    0x86: {
      ...
      multiple: false,
      webm: true,
      description: 'An ID corresponding to the codec; see [@?I-D.ietf-cellar-codec] for more info.',
      mandatory: true,
      minver: 1,
      crc: false
    },
    0x88: {
      ...
      multiple: false,
      webm: true,
      description: 'Set to 1 if the track (audio, video, or subtitles) is eligible for automatic selection by the player; see (#default-track-selection) for more details.',
      mandatory: true,
      range: '0-1',
    ...
    0x96: {
      ...
      type: 'u',
      multiple: false,
      description: 'Timestamp of the referenced `Block`, expressed in Segment Ticks which is based on `TimestampScale`; see (#timestamp-ticks).',
      mandatory: true,
      minver: 2,
      crc: false
    },
    ...
    0x98: {
      ...
      type: 'u',
      multiple: false,
      description: 'Set to 1 if a chapter is hidden. Hidden chapters **SHOULD NOT** be available to the user interface (but still be available to Control Tracks; see (#chapterflaghidden) on `Chapter` flags).',
      mandatory: true,
      range: '0-1',
      minver: 1,
      default: '0',
    ...
    0x9a: {
      ...
      multiple: false,
      webm: true,
      description: 'Specifies whether the video frames in this track are interlaced.',
      mandatory: true,
    ...
    0x9c: {
      ...
      multiple: false,
      webm: true,
      description: `Set to 1 if the track **MAY** contain blocks that use lacing. When set to 0, all blocks **MUST** have their lacing flags set to "no lacing"; see (#block-lacing) on 'Block' Lacing.`,
      mandatory: true,
      range: '0-1',
    ...
    0x9d: {
      ...
      type: 'u',
      multiple: false,
      description: 'Specifies the field ordering of video frames in this track.',
      mandatory: true,
    ...
    0xa3: {
      ...
      multiple: true,
      webm: true,
      description: 'Similar to `Block` (see (#block-structure)) but without all the extra information. Mostly used to reduce overhead when no extra feature is needed; see (#simpleblock-structure) on `SimpleBlock` Structure.',
      minver: 2,
      divx: true,
      crc: false
    },
    ...
    0xa6: {
      ...
      multiple: true,
      webm: true,
      description: 'Contains the `BlockAdditional` and some parameters.',
      mandatory: true,
      minver: 1,
      crc: false
    },
    0xa7: {
      ...
      type: 'u',
      multiple: false,
      description: 'The `Segment Position` of the `Cluster` in the `Segment` (0 in live streams). It might help to resynchronize the offset on damaged streams.',
    ...
    0xaf: {
      ...
      type: 'b',
      multiple: true,
      description: 'Similar to `SimpleBlock` (see (#simpleblock-structure)), but the data inside the `Block` are Transformed (encrypted and/or signed).',
      minver: 0,
      maxver: 0,
      crc: false
    },
    ...
    0xb2: {
      ...
      multiple: false,
      webm: true,
      description: "The duration of the block, expressed in Segment Ticks, which are based on `TimestampScale`; see (#timestamp-ticks). If missing, the track's `DefaultDuration` does not apply and no duration information is available in terms of the cues.",
      minver: 4,
      crc: false
    },
    0xb3: {
      ...
      multiple: false,
      webm: true,
      description: 'Absolute timestamp of the seek point, expressed in Segment Ticks, which are based on `TimestampScale`; see (#timestamp-ticks).',
      mandatory: true,
      minver: 1,
      crc: false
    },
    ...
    0xb6: {
      ...
      multiple: true,
      webm: true,
      description: 'Contains the atom information to use as the chapter atom (applies to all tracks).',
      mandatory: true,
      minver: 1,
      crc: false
    },
    0xb7: {
      ...
      multiple: true,
      webm: true,
      description: 'Contains positions for different tracks corresponding to the timestamp.',
      mandatory: true,
      minver: 1,
      crc: false
    },
    0xb9: {
      ...
      multiple: false,
      webm: true,
      description: 'Set to 1 if the track is usable. It is possible to turn a track that is not usable into a usable track using chapter codecs or control tracks.',
      mandatory: true,
      range: '0-1',
    ...
    0xc1: {
      ...
      type: 'b',
      multiple: false,
      description: 'The `SegmentUUID` of the `Segment` containing the track identified by TrickTrackUID. See [@?DivXTrickTrack].',
      minver: 0,
      maxver: 0,
      divx: true,
      crc: false
    ...
    0xc4: {
      ...
      type: 'b',
      multiple: false,
      description: 'The `SegmentUUID` of the `Segment` containing the track identified by MasterTrackUID. See [@?DivXTrickTrack].',
      minver: 0,
      maxver: 0,
      divx: true,
      crc: false
    ...
    0xcd: {
      ...
      type: 'u',
      multiple: false,
      description: 'The number of the frame to generate from this lace with this delay (allows for the generation of many frames from the same Block/Frame).',
    ...
    0xe2: {
      ...
      type: 'm',
      multiple: false,
      description: 'Operation that needs to be applied on tracks to create this virtual track. For more details, see (#track-operation).',
      minver: 3,
      crc: false
    },
    0xe3: {
    ...
    0xe4: {
      ...
      type: 'm',
      multiple: true,
      description: 'Contains a video plane track that needs to be combined to create this 3D track.',
      mandatory: true,
      minver: 3,
      crc: false
    },
    ...
    0xe7: {
      ...
      multiple: false,
      webm: true,
      description: 'Absolute timestamp of the cluster, expressed in Segment Ticks, which are based on `TimestampScale`; see (#timestamp-ticks).',
      mandatory: true,
    ...
    0xea: {
      ...
      type: 'u',
      multiple: false,
      description: 'The `Segment Position` ((#segment-position)) of the Codec State corresponding to this `Cues` element. 0 means that the data is taken from the initial `TrackEntry`.',
      mandatory: true,
      minver: 2,
      default: '0',
      crc: false
    ...
    0xeb: {
      ...
      type: 'u',
      multiple: false,
      description: 'The `Segment Position` of the Codec State corresponding to this referenced element. 0 means that the data is taken from the initial `TrackEntry`.',
      minver: 0,
      maxver: 0,
      default: '0',
      crc: false
    ...
    0xfa: {
      ...
      type: 'u',
      multiple: false,
      description: 'This frame is referenced and has the specified cache priority. In the cache, only a frame of the same or higher priority can replace this frame. A value of 0 means the frame is not referenced.',
      mandatory: true,
      minver: 1,
      default: '0',
      crc: false
    ...
    0x4255: {
      ...
      type: 'b',
      multiple: false,
      description: 'Settings that might be needed by the decompressor. For Header Stripping (`ContentCompAlgo`=3), the bytes that were removed from the beginning of each frame of the track.',
      minver: 1,
      crc: false
    },
    0x4281: {
    ...
    0x437d: {
      ...
      type: 's',
      multiple: true,
      description: 'A language corresponding to the `ChapString`, in the form defined in [@!RFC5646]; see (#language-codes) on language codes. If a `ChapLanguageBCP47` element is used, then any `ChapLanguage` and `ChapCountry` elements used in the same `ChapterDisplay` **MUST** be ignored.',
    ...
    0x4444: {
      ...
      type: 'b',
      multiple: true,
      description: 'A UID that all `Segments` of a `Linked Segment` **MUST** share (128 bits). It is equivalent to a UUID v4 [@!RFC9562] with all bits randomly (or pseudorandomly) chosen. An actual UUID v4 value, where some bits are not random, **MAY** also be used.',
      minver: 1,
      crc: false
    },
    0x4461: {
    ...
    0x447a: {
      ...
      multiple: false,
      webm: true,
      description: 'Specifies the language of the specified tag in the Matroska languages form; see (#language-codes) on language codes. This element **MUST** be ignored if the `TagLanguageBCP47` element is used within the same `SimpleTag` element.',
      mandatory: true,
      cppname: 'TagLangue',
      minver: 1,
      default: 'und',
    ...
    0x447b: {
      ...
      type: 's',
      multiple: false,
      description: 'The language used in the `TagString`, in the form defined in [@!RFC5646]; see (#language-codes) on language codes. If this element is used, then any `TagLanguage` elements used in the same `SimpleTag` **MUST** be ignored.',
    ...
    0x4485: {
      ...
      multiple: false,
      webm: true,
      description: 'The tag value if it is binary. Note that this cannot be used in the same `SimpleTag` as `TagString`.',
      minver: 1,
      crc: false
    },
    0x4487: {
    ...
    0x4489: {
      ...
      multiple: false,
      webm: true,
      description: 'Duration of the `Segment`, expressed in `Segment` Ticks, which are based on `TimestampScale`; see (#timestamp-ticks).',
      range: '> 0x0p+0',
      minver: 1,
      crc: false
    },
    ...
    0x450d: {
      ...
      type: 'b',
      multiple: false,
      description: 'Optional data attached to the `ChapProcessCodecID` information. For `ChapProcessCodecID` = 1, it is the "DVD level" equivalent; see (#menu-features) on DVD menus.',
    ...
    0x45a3: {
      ...
      multiple: false,
      webm: true,
      description: 'The name of the tag value that is going to be stored.',
      mandatory: true,
      minver: 1,
      crc: false
    },
    ...
    0x45bc: {
      ...
      type: 'u',
      multiple: false,
      description: "A UID that identifies the edition. It's useful for tagging an edition.",
      range: 'not 0',
      minver: 1,
      crc: false
    },
    0x45bd: {
      ...
      type: 'u',
      multiple: false,
      description: 'Set to 1 if an edition is hidden. Hidden editions **SHOULD NOT** be available to the user interface (but still be available to Control Tracks; see (#chapter-flags) on `Chapter` flags).',
      mandatory: true,
      range: '0-1',
      minver: 1,
      default: '0',
    ...
    0x45e4: {
      ...
      type: 's',
      multiple: true,
      description: 'One language corresponding to the EditionString, in the form defined in [@!RFC5646]; see (#language-codes) on language codes.',
      minver: 5,
      crc: false
    },
    0x465c: {
    ...
    0x4660: {
      ...
      type: 's',
      multiple: false,
      description: 'Media type of the file following the format described in [@!RFC6838].',
      mandatory: true,
      cppname: 'MimeType',
      minver: 1,
      crc: false
    ...
    0x4661: {
      ...
      type: 'u',
      multiple: false,
      description: 'The timestamp at which this optimized font attachment comes into context, expressed in Segment Ticks, which are based on `TimestampScale`. See [@?DivXWorldFonts].',
      minver: 0,
      maxver: 0,
      divx: true,
      crc: false
    ...
    0x4662: {
      ...
      type: 'u',
      multiple: false,
      description: 'The timestamp at which this optimized font attachment goes out of context, expressed in Segment Ticks, which are based on `TimestampScale`. See [@?DivXWorldFonts].',
      minver: 0,
      maxver: 0,
      divx: true,
      crc: false
    ...
    0x46ae: {
      ...
      type: 'u',
      multiple: false,
      description: 'UID representing the file, as random as possible.',
      mandatory: true,
      range: 'not 0',
      minver: 1,
      crc: false
    ...
    0x47e2: {
      ...
      multiple: false,
      webm: true,
      description: 'For public key algorithms, the ID of the public key that the data was encrypted with.',
      minver: 1,
      crc: false
    },
    0x47e3: {
    ...
    0x47e4: {
      ...
      type: 'b',
      multiple: false,
      description: 'This is the ID of the private key that the data was signed with.',
      minver: 1,
      maxver: 0,
      crc: false
    },
    ...
    0x5033: {
      ...
      multiple: false,
      webm: true,
      description: 'A value describing the kind of transformation that is applied.',
      mandatory: true,
      minver: 1,
      default: '0',
      crc: false
    ...
    0x5034: {
      ...
      type: 'm',
      multiple: false,
      description: 'Settings describing the compression used. This element **MUST** be present if the value of `ContentEncodingType` is 0 and absent otherwise. Each block **MUST** be decompressable, even if no previous block is available in order to not prevent seeking.',
      minver: 1,
      crc: false
    },
    0x5035: {
    ...
    0x53b8: {
      ...
      multiple: false,
      webm: true,
      description: 'Stereo-3D video mode. See (#multi-planar-and-3d-videos) for more details.',
      mandatory: true,
    ...
    0x53c0: {
      ...
      multiple: false,
      webm: true,
      description: 'Indicates whether the `BlockAdditional` element with `BlockAddID` of "1" contains Alpha data as defined by the Codec Mapping for the `CodecID`. Undefined values (i.e., values other than 0 or 1) **SHOULD NOT** be used, as the behavior of known implementations is different.',
      mandatory: true,
    ...
    0x54b2: {
      ...
      multiple: false,
      webm: true,
      description: 'How `DisplayWidth` and `DisplayHeight` are interpreted.',
      mandatory: true,
    ...
    0x54b3: {
      ...
      type: 'u',
      multiple: false,
      description: 'Specifies the possible modifications to the aspect ratio.',
    ...
    0x55ab: {
      ...
      type: 'u',
      multiple: false,
      description: 'Set to 1 if and only if the track is suitable for users with hearing impairments.',
      range: '0-1',
      minver: 4,
      crc: false
    },
    0x55ac: {
      ...
      type: 'u',
      multiple: false,
      description: 'Set to 1 if and only if the track is suitable for users with visual impairments.',
      range: '0-1',
      minver: 4,
      crc: false
    },
    0x55ad: {
      ...
      type: 'u',
      multiple: false,
      description: 'Set to 1 if and only if the track contains textual descriptions of video content.',
      range: '0-1',
      minver: 4,
      crc: false
    },
    0x55ae: {
      ...
      type: 'u',
      multiple: false,
      description: "Set to 1 if and only if the track is in the content's original language.",
      range: '0-1',
      minver: 4,
      crc: false
    },
    0x55af: {
      ...
      type: 'u',
      multiple: false,
      description: 'Set to 1 if and only if the track contains commentary.',
      range: '0-1',
      minver: 4,
      crc: false
    },
    0x55b0: {
      ...
      multiple: false,
      webm: true,
      description: 'Settings describing the color format.',
      cppname: 'VideoColour',
      minver: 4,
      crc: false
    },
    0x55b1: {
      ...
      multiple: false,
      webm: true,
      description: 'The Matrix Coefficients of the video used to derive luma and chroma values from red, green, and blue color primaries. For clarity, the value and meanings for `MatrixCoefficients` are adopted from Table 4 of [@!ITU-H.273].',
      mandatory: true,
    ...
    0x55b3: {
      ...
      multiple: false,
      webm: true,
      description: 'The number of pixels to remove in the Cr and Cb channels for every pixel not removed horizontally. Example: For video with 4:2:0 chroma subsampling, the `ChromaSubsamplingHorz` **SHOULD** be set to 1.',
    ...
    0x55b4: {
      ...
      multiple: false,
      webm: true,
      description: 'The number of pixels to remove in the Cr and Cb channels for every pixel not removed vertically. Example: For video with 4:2:0 chroma subsampling, the `ChromaSubsamplingVert` **SHOULD** be set to 1.',
    ...
    0x55b5: {
      ...
      multiple: false,
      webm: true,
      description: 'The number of pixels to remove in the Cb channel for every pixel not removed horizontally. This is additive with `ChromaSubsamplingHorz`. Example: For video with 4:2:1 chroma subsampling, the `ChromaSubsamplingHorz` **SHOULD** be set to 1, and `CbSubsamplingHorz` **SHOULD** be set to 1.',
    ...
    0x55b6: {
      ...
      multiple: false,
      webm: true,
      description: 'The number of pixels to remove in the Cb channel for every pixel not removed vertically. This is additive with `ChromaSubsamplingVert`.',
    ...
    0x55ba: {
      ...
      multiple: false,
      webm: true,
      description: 'The transfer characteristics of the video. For clarity, the value and meanings for `TransferCharacteristics` are adopted from Table 3 of [@!ITU-H.273].',
      mandatory: true,
    ...
    0x55bb: {
      ...
      multiple: false,
      webm: true,
      description: 'The color primaries of the video. For clarity, the value and meanings for `Primaries` are adopted from Table 2 of [@!ITU-H.273].',
      mandatory: true,
    ...
    0x55ee: {
      ...
      type: 'u',
      multiple: false,
      description: 'The maximum value of `BlockAddID` ((#blockaddid-element)). A value of 0 means there is no `BlockAdditions` ((#blockadditions-element)) for this track.',
      mandatory: true,
      minver: 1,
      default: '0',
      crc: false
    ...
    0x5654: {
      ...
      multiple: false,
      webm: true,
      description: 'A unique string ID that identifies the `Chapter`. For example, it is used as the storage for cue identifier values [@?WebVTT].',
      minver: 3,
      crc: false
    },
    0x56aa: {
    ...
    0x56bb: {
      ...
      multiple: false,
      webm: true,
      description: 'After a discontinuity, the duration of the data that the decoder **MUST** decode before the decoded data is valid, expressed in Matroska Ticks -- i.e., in nanoseconds; see (#timestamp-ticks).',
      mandatory: true,
      minver: 4,
      default: '0',
      crc: false
    ...
    0x5854: {
      ...
      type: 'm',
      multiple: false,
      description: 'The list of tracks that are not used in that part of the stream. It is useful when using overlay tracks for seeking or deciding what track to use.',
    ...
    0x58d7: {
      ...
      type: 'u',
      multiple: true,
      description: 'One of the track numbers that is not used from now on in the stream. It could change later if not specified as silent in a further `Cluster`.',
    ...
    0x63c0: {
      ...
      multiple: false,
      webm: true,
      description: 'Specifies which other elements the metadata represented by the tag value applies to. If empty or omitted, then the tag value describes everything in the `Segment`.',
      mandatory: true,
      cppname: 'TagTargets',
      minver: 1,
      crc: false
    ...
    0x63c3: {
      ...
      type: 'u',
      multiple: false,
      description: 'Specifies the physical equivalent of this `ChapterAtom`, e.g., "DVD" (60) or "SIDE" (50); see (#physical-types) for a complete list of values.',
      minver: 1,
      crc: false
    },
    0x63c4: {
      ...
      type: 'u',
      multiple: true,
      description: 'A UID that identifies the `Chapter(s)` that the tags belong to.',
      minver: 1,
      default: '0',
      crc: false
    },
    0x63c5: {
      ...
      multiple: true,
      webm: true,
      description: 'A UID that identifies the `Track(s)` that the tags belong to.',
      minver: 1,
      default: '0',
      crc: false
    },
    0x63c6: {
      ...
      type: 'u',
      multiple: true,
      description: 'A UID that identifies the Attachment(s) that the tags belong to.',
      minver: 1,
      default: '0',
      crc: false
    },
    0x63c9: {
      ...
      type: 'u',
      multiple: true,
      description: 'A UID that identifies the `EditionEntry(s)` that the tags belong to.',
      minver: 1,
      default: '0',
      crc: false
    },
    0x63ca: {
      ...
      multiple: false,
      webm: true,
      description: 'An informational string that can be used to display the logical level of the target, such as "ALBUM", "TRACK", "MOVIE", "CHAPTER", etc.',
    ...
    0x66bf: {
      ...
      type: 'u',
      multiple: false,
      description: 'Applies to the chapter codec of the given chapter edition(s); see (#chapprocesscodecid-element).',
      mandatory: true,
      minver: 1,
      crc: false
    },
    0x66fc: {
      ...
      type: 'u',
      multiple: true,
      description: 'Specifies a chapter edition UID to which this `TrackTranslate` applies.',
      minver: 1,
      crc: false
    },
    0x67c8: {
    ...
    0x6911: {
      ...
      type: 'm',
      multiple: true,
      description: 'Contains all the commands associated with the Atom.',
    ...
    0x6955: {
      ...
      type: 'u',
      multiple: false,
      description: 'Contains the type of the codec used for processing.',
      mandatory: true,
    ...
    0x69fc: {
      ...
      type: 'u',
      multiple: true,
      description: 'Specifies a chapter edition UID to which this `ChapterTranslate` applies.',
      minver: 1,
      crc: false
    },
    0x6d80: {
    ...
    0x6fab: {
      ...
      type: 'u',
      multiple: true,
      description: 'Specify that this track is an overlay track for the `Track` specified (in the u-integer). This means that when this track has a gap on `SilentTracks`, the overlay track should be used instead. The order of multiple `TrackOverlay` matters; the first one is the one that should be used. If the first one is not found, it should be the second, etc.',
      minver: 1,
      maxver: 0,
      crc: false
    },
    ...
    0x73a4: {
      ...
      type: 'b',
      multiple: false,
      description: 'A randomly generated UID that identifies the `Segment` amongst many others (128 bits). It is equivalent to a Universally Unique Identifier (UUID) v4 [@!RFC9562] with all bits randomly (or pseudorandomly) chosen.  An actual UUID v4 value, where some bits are not random, **MAY** also be used.',
      cppname: 'SegmentUID',
      minver: 1,
      crc: false
    },
    0x73c4: {
      ...
      multiple: false,
      webm: true,
      description: 'A UID that identifies the `Chapter`.',
      mandatory: true,
      range: 'not 0',
      minver: 1,
      crc: false
    ...
    0x73c5: {
      ...
      multiple: false,
      webm: true,
      description: 'A UID that identifies the `Track`.',
      mandatory: true,
      range: 'not 0',
      minver: 1,
      crc: false
    ...
    0x75a1: {
      ...
      multiple: false,
      webm: true,
      description: 'Contains additional binary data to complete the `Block` element; see [@?I-D.ietf-cellar-codec, section 4.1.5] for more information. An EBML parser that has no knowledge of the `Block` structure could still see and use/skip these data.',
      minver: 1,
      crc: false
    },
    0x75a2: {
      ...
      multiple: false,
      webm: true,
      description: 'Duration of the silent data added to the `Block`, expressed in Matroska Ticks -- i.e., in nanoseconds; see (#timestamp-ticks) (padding at the end of the `Block` for positive values and at the beginning of the `Block` for negative values).  The duration of `DiscardPadding` is not calculated in the duration of the `TrackEntry` and **SHOULD** be discarded during playback.',
      minver: 4,
      crc: false
    },
    0x7670: {
      ...
      multiple: false,
      webm: true,
      description: 'Describes the video projection details. Used to render spherical or VR videos or to flip videos horizontally or vertically.',
    ...
    0x78b5: {
      ...
      multiple: false,
      webm: true,
      description: 'Real output sampling frequency in Hz that is used for Spectral Band Replication (SBR) techniques.',
      range: '> 0x0p+0',
    ...
    0x22b59d: {
      ...
      type: 's',
      multiple: false,
      description: 'The language of the track, in the form defined in [@!RFC5646]; see (#language-codes) on language codes. If this element is used, then any `Language` elements used in the same `TrackEntry` **MUST** be ignored.',
    ...
    0x26b240: {
      ...
      type: 's',
      multiple: true,
      description: 'A URL to download information about the codec used.',
      minver: 0,
      maxver: 0,
      crc: false
    },
    ...
    0x3cb923: {
      ...
      type: 'b',
      multiple: false,
      description: 'An ID that identifies the previous `Segment` of a `Linked Segment`.',
      cppname: 'PrevUID',
      minver: 1,
      crc: false
    },
    ...
    0x3eb923: {
      ...
      type: 'b',
      multiple: false,
      description: 'An ID that identifies the next `Segment` of a `Linked Segment`.',
      cppname: 'NextUID',
      minver: 1,
      crc: false
    },
    0x1043a770: {
      ...
      multiple: false,
      webm: true,
      description: 'A system to define basic menus and partition data. For more detailed information, see (#chapters).',
      minver: 1,
      crc: false
    },
    0x114d9b74: {
    ...
    0x1254c367: {
      ...
      multiple: true,
      webm: true,
      description: 'Element containing metadata describing `Tracks`, `Editions`, `Chapters`, `Attachments`, or the `Segment` as a whole. A list of valid tags can be found in [@?I-D.ietf-cellar-tags].',
      minver: 1,
      crc: false
    },
    0x1549a966: {
    ...
    0x1941a469: {
      ...
      type: 'm',
      multiple: false,
      description: 'Contains attached files.',
      minver: 1,
      crc: false
    },
    0x1a45dfa3: {
